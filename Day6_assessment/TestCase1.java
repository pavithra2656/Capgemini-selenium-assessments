...
public class TestCase1 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		FileInputStream fis=new FileInputStream("./src/test/java/Day_6_Assessment/orangeHRM.properties");
		...
		FileInputStream file=new FileInputStream("./src/test/java/Day_6_Assessment/orangeHRM1.xlsx");
		...
		Thread.sleep(2000);
		String record = driver.findElement(By.xpath("//div[text()='" + user + "']")).getText();
